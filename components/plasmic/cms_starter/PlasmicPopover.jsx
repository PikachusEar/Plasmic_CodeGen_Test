...
import Button from "../../Button"; // plasmic-import: lv_ZEXT3JZzV/component
import { BasePopover } from "@plasmicpkgs/react-aria/skinny/registerPopover";
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: lL9SoayVyCtn/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: rcl36Lh1kyKB/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__natlc)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__lnwFm)}
            label={"Open Popover"}
          />
        ),
