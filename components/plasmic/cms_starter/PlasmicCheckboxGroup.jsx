...
import Label from "../../Label"; // plasmic-import: 2tG6HrVCllrV/component
import Checkbox from "../../Checkbox"; // plasmic-import: ORMPIqBKq95K/component
import Description from "../../Description"; // plasmic-import: JtcYU1VZMxxH/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: 3-lkUPAuNPl5/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__qPeyw)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___7HxCm)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ppS3X)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___9MM3)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
